...
class MainActivity : AppCompatActivity() {
    ...
    //innerをつけることによって、インナークラスとなり、外部の変数(binding)を参照できるようになる
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //CountDownTimerクラスを継承したクラスのインスタンスを生成
        //タイマーの継続時間として３分、onTickメソッドが呼ばれる間隔として0.1秒を設定
    ...
    //音楽データはメモリを多く消費するので、アクティビティが表示されたときに
    //onResume()でロード
    override fun onResume() {
        super.onResume()
        //SoundPool.Builderクラスを利用してインスタンスを生成
        soundPool =
